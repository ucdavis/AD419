    ...
    [
        ...
        new(
            ...
            [
                ...
                Text("PreapplicationCoordination091", false, null, "Preapplication Coordination 091", "091 Preapplication Coordination"),
                Text("ApplicationProcedures092", false, null, "Application Procedures 092", "092 Application Procedures"),
                Text("AwardProcedure093", false, null, "Award Procedure 093", "093 Award Procedure"),
                Text("Deadlines094", false, null, "Deadlines 094", "094 Deadlines"),
                Text("RangeOfApprovalDisapprovalTime095", false, null, "Range Of Approval Disapproval Time 095", "095 Range Of Approval Disapproval Time"),
                Text("Appeals096", false, null, "Appeals 096", "096 Appeals"),
                Text("Renewals097", false, null, "Renewals 097", "097 Renewals"),
                Text("FormulaAndMatchingRequirements101", false, null, "Formula And Matching Requirements 101", "101 Formula And Matching Requirements"),
                Text("LengthAndTimePhasingOfAssistance102", false, null, "Length And Time Phasing Of Assistance 102", "102 Length And Time Phasing Of Assistance"),
                Text("Reports111", false, null, "Reports 111", "111 Reports"),
                Text("Audits112", false, null, "Audits 112", "112 Audits"),
                Text("Records113", false, null, "Records 113", "113 Records"),
                Text("AccountIdentification121", false, null, "Account Identification 121", "121 Account Identification"),
                Text("Obligations122", false, null, "Obligations 122", "122 Obligations"),
                ...
                Text("ProgramAccomplishments130", false, null, "Program Accomplishments 130", "130 Program Accomplishments"),
                Text("RegulationsGuidelinesAndLiterature140", false, null, "Regulations Guidelines And Literature 140", "140 Regulations Guidelines And Literature"),
                Text("RegionalOrLocalOffice151", false, null, "Regional Or Local Office 151", "151 Regional Or Local Office"),
                Text("HeadquartersOffice152", false, null, "Headquarters Office 152", "152 Headquarters Office"),
