        ...
        <Ajax:UpdateProgress ID="progressReportingModule" runat="server">
            <ProgressTemplate>
                <div class="loadingbox">
                    <br />
                    <img src="images/indicator_mozilla_blu.gif" alt="Progress" id="IMG1" />
                    Calculating...
                </div>
            </ProgressTemplate>
        </Ajax:UpdateProgress>
        <asp:ImageButton ID="ibutProjects" runat="server" ImageUrl="~/images/projects_sel.gif"
            OnClick="ibutProjects_Click" /><asp:ImageButton ID="ibutAssociations" runat="server"
                ImageUrl="~/images/associations_unsel.gif" OnClick="ibutAssociations_Click" /><asp:ImageButton
                    ID="ibutReports" runat="server" ImageUrl="~/images/reports_unsel.gif" OnClick="ibutReports_Click" /><br />
        <table border="0" cellpadding="0" cellspacing="0" width="980">
            <tr style="background-color: #FFFFFF;">
                <td style="width: 17px; height: 18px;">
                    <img src="images/corn_lefttop.gif" alt="" />
                </td>
                <td style="height: 18px">
                    <img src="images/spaceholder.gif" alt="" />
                </td>
                <td style="width: 17px; height: 18px;">
                    <img src="images/corn_righttop.gif" alt="" />
                </td>
            </tr>
            <tr style="background-color: #ffffff;">
                    ...
                    <asp:Panel ID="pnlProjectInfo" runat="server" Width="100%">
                        <div style="float: left;">
                            <div style="background-image: url(images/rm_bluemodbg.gif); background-repeat: repeat-y;
                                vertical-align: top; width: 429px;">
                                <div style="background-image: url(images/rm_bluemod_03.jpg); background-repeat: no-repeat;
                                    padding-left: 25px;">
                                    <br />
                                    <br />
                                    Department:<asp:DropDownList ID="dlistDepartment" runat="server" AutoPostBack="True"
                                        DataSourceID="AD419DataReportingOrg" DataTextField="Org-Dept" DataValueField="OrgR"
                                        OnSelectedIndexChanged="dlistDepartment_SelectedIndexChanged" AppendDataBoundItems="True"
                                        OnDataBound="dlistDepartment_DataBound">
                                    ...
                                    <asp:GridView ID="gv_TotalExpensesByDept" runat="server" AutoGenerateColumns="False"
                                        BorderStyle="None" BorderWidth="0px" GridLines="None" Height="100%" OnRowDataBound="gv_TotalExpensesByDept_RowDataBound"
                                        CellSpacing="5">
                                        <Columns>
                            ...
                            <img src="images/rm_bluemod_05.jpg" alt="" height="42" /></div>
                        <div style="float: right">
                            <div style="background-image: url(images/rm_totalmod_04.gif); background-repeat: no-repeat;
                                ...
                                <Ajax:UpdatePanel ID="updateViewMode" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <asp:ImageButton ID="ibtnSFNUnassociated" runat="server" ImageUrl="~/images/unass_unsel.gif"
                                            CommandArgument="3" OnClick="ibtnSFNUnassociated_Click" />
                                        <asp:ImageButton ID="ibtnSFNProject" runat="server" ImageUrl="~/images/proj_unsel.gif"
                                            CommandArgument="4" OnClick="ibtnSFNProject_Click" />
                                    </ContentTemplate>
                                </Ajax:UpdatePanel>
                            </div>
                            <%--
            ...
            --%>
                                        ...
                                        <Ajax:UpdatePanel ID="updateTotalExpenses" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:GridView ID="gViewSFNTotalExpenses" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    ForeColor="White" GridLines="Horizontal" OnPreRender="gViewSFNTotalExpenses_PreRender"
                                                    Width="487px" BorderColor="White">
                            ...
                            <img src="images/rm_totalmod_13.jpg" alt="" />
                        </div>
                        <br />
                        <div style="float: left;">
            ...
            --%>
                                    <br />
                                    <br />
                                    <table id="projectsHeader" width="384" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="height: 20px">
                                                <strong>Projects:</strong>
                                            </td>
                                            <td style="height: 20px">
                                                <asp:Label ID="lblProjectsActive" runat="server" CssClass="labelboxes" ForeColor="#0066FF">12</asp:Label>
                                                <strong style="color: #0066ff">Active</strong>
                                            </td>
                                            <td style="height: 20px">
                                                <asp:Label ID="lblProjectsExpired" runat="server" CssClass="labelboxes" ForeColor="#C00000">12</asp:Label>
                                                <strong style="color: #cc0000">Expired</strong>
                                            </td>
                                            <td style="height: 20px">
                                                <asp:Label ID="lblProjectsTotal" runat="server" CssClass="labelboxes">12</asp:Label>
                                                <strong>Total</strong>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <table id="ProjectsBody" width="384" cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="dlistProjectID" runat="server" AutoPostBack="True" DataSourceID="AD419DataProjects"
                                                            DataTextField="Project" DataValueField="Project" OnSelectedIndexChanged="dlistProjectID_SelectedIndexChanged">
                                                            <asp:ListItem Text="-- Choose A Project --"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="lblProjectAccession" runat="server" CssClass="labelboxesdark"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                            <br />
                                            <table id="ProjectsBodyInvestigators" width="384" cellpadding="0" cellspacing="0"
                                                border="0">
                                                <tr>
                                                ...
                                                <tr>
                                                    <td style="width: 128px; height: 32px;">
                                                        <asp:TextBox ID="lblProjectInvestigator1" CssClass="labelboxes" runat="server" EnableViewState="False"
                                                            Width="100px">&nbsp;</asp:TextBox>
                                                    </td>
                                                    <td style="width: 128px;">
                                                        <asp:TextBox ID="lblProjectInvestigator2" CssClass="labelboxes" runat="server" EnableViewState="False"
                                                            Width="100px">&nbsp;</asp:TextBox>
                                                    </td>
                                                    <td style="width: 128px;">
                                                        <asp:TextBox ID="lblProjectInvestigator3" CssClass="labelboxes" runat="server" EnableViewState="False"
                                                            Width="100px">&nbsp;</asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="height: 21px;">
                                                        <asp:TextBox ID="lblProjectInvestigator4" CssClass="labelboxes" runat="server" EnableViewState="False"
                                                            Width="100px">&nbsp;</asp:TextBox><br />
                                                        <br />
                                                    </td>
                                                    <td style="width: 128px">
                                                        <asp:TextBox ID="lblProjectInvestigator5" CssClass="labelboxes" runat="server" EnableViewState="False"
                                                            Width="100px">&nbsp;</asp:TextBox><br />
                                                        <br />
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="lblProjectInvestigator6" CssClass="labelboxes" runat="server" EnableViewState="False"
                                                            Width="100px">&nbsp;</asp:TextBox><br />
                                                        <br />
                                                    </td>
                                                </tr>
                                            ...
                                            <table id="ProjectsBodyInfo" width="388" cellpadding="0" cellspacing="0" border="0">
                                                <tr style="height: 19px;">
                                                    <td style="width: 194px;">
                                                        ...
                                                        <br />
                                                        <asp:TextBox ID="lblBeginningDate" runat="server" EnableViewState="False" CssClass="labelboxes"
                                                            Width="70px">begdate</asp:TextBox><br />
                                                        <br />
                                                    </td>
                                                    <td style="width: 194px;">
                                                        <strong>Termination Date</strong>
                                                        <br />
                                                        <asp:TextBox ID="lblTerminationDate" runat="server" EnableViewState="False" CssClass="labelboxes"
                                                            Width="70px">termdate</asp:TextBox><br />
                                                        <br />
                                                    </td>
                                                </tr>
                                                <tr style="height: 19px;">
                                                    <td>
                                                        <strong>CRIS Status Type</strong>
                                                    </td>
                                                    <td>
                                                        <strong>CRIS Project Type</strong>
                                                    </td>
                                                </tr>
                                                <tr style="height: 19px;">
                                                    <td>
                                                        <asp:TextBox ID="lblProjectStatusType" runat="server" EnableViewState="False" CssClass="labelboxesdark"
                                                            Width="160px">statustype</asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="lblProjectType" runat="server" EnableViewState="False" CssClass="labelboxesdark"
                                                            Width="160px">projectype</asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr style="height: 19px;">
                                                    <td>
                                                        <strong>Regional Project Number</strong>
                                                    </td>
                                                    <td>
                                                        <strong>CRIS Funding Type</strong>
                                                    </td>
                                                </tr>
                                                <tr style="height: 19px;">
                                                    <td>
                                                        <asp:TextBox ID="lblProjectNumber" runat="server" EnableViewState="False" CssClass="labelboxesdark"
                                                            Width="160px">projnumber</asp:TextBox><br />
                                                        <br />
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="lblProjectFundingType" runat="server" EnableViewState="False" CssClass="labelboxesdark"
                                                            Width="160px">projfundtype</asp:TextBox><br />
                                                        <br />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3" align="center" style="height: 13px">
                                                        <strong>Project Title / Description</strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3" style="height: 24px;">
                                                        <asp:TextBox ID="txtProjectDescription" runat="server" TextMode="MultiLine" Width="380px"
                                    ...
                                    <asp:ObjectDataSource ID="AD419DataReportingOrg" runat="server" SelectMethod="getReportingOrgFiltered"
                        ...
                        <img src="images/rm_bluemod_05.jpg" width="429" alt="" />
                    </asp:Panel>
                    <asp:Panel ID="pnlAssociations" runat="server" Visible="false">
                        Department:
                        <asp:DropDownList ID="dlistAssociationsDepartment" runat="server" AutoPostBack="True"
                            DataSourceID="AD419DataAssociationsReportingOrg" DataTextField="Org-Dept" DataValueField="OrgR">
                        </asp:DropDownList>
                        <br />
                        <asp:ObjectDataSource ID="AD419DataAssociationsReportingOrg" runat="server" SelectMethod="getReportingOrgFiltered"
                            TypeName="CAESDO.AD419DataAccess">
                            <SelectParameters>
                                <asp:Parameter DefaultValue="<%$ Code: (HttpContext.Current.User.Identity.Name) %>"
                                    Name="loginID" Type="String" />
                        ...
                        <div id="AssociationsHeader" style="float: left; width: 540px;">
                            <div style="background-image: url(images/rm_associationsbig.gif); background-repeat: no-repeat;
                                padding-left: 21px; padding-right: 20px; padding-top: 25px; padding-bottom: 10px;">
                ...
                --%>
                                        <br />
                                        <strong>Show:</strong> &nbsp;&nbsp;
                                        <asp:CheckBox ID="cboxAssociated" runat="server" Text="Associated" AutoPostBack="True"
                                            OnCheckedChanged="cboxAssociated_CheckedChanged" OnPreRender="cboxAssociated_PreRender" />&nbsp;
                                        <asp:CheckBox ID="cboxUnassociated" runat="server" Text="Unassociated" Checked="true"
                                            AutoPostBack="True" OnCheckedChanged="cboxUnassociated_CheckedChanged" OnPreRender="cboxUnassociated_PreRender" />
                                    </ContentTemplate>
                                </Ajax:UpdatePanel>
                            </div>
                                    ...
                                    <td>
                                        ...
                                        <div style="overflow: auto; height: 349px; width: 520px; visibility: visible;">
                                            <Ajax:UpdatePanel ID="updateAssociationsGrouping" runat="server" UpdateMode="conditional">
                                                <ContentTemplate>
                                                    <asp:GridView ID="gvAssociationRecords" runat="server" AllowSorting="True" DataSourceID="AD419DataExpenseRecordGrouping"
                                                        AutoGenerateColumns="False" CellPadding="4" CssClass="bordertop" ForeColor="White"
                                                        GridLines="Horizontal" EmptyDataText="No Records Found" DataKeyNames="isAssociated,Code"
                                                        OnPreRender="gvAssociationRecords_PreRender" OnSorted="gvAssociationRecords_Sorted"
                                                        BorderColor="White" Width="100%" AllowPaging="True" OnPageIndexChanged="gvAssociationRecords_PageIndexChanged"
                                                        PageSize="200">
                                                        <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="FTE" HeaderText="FTE" SortExpression="FTE" DataFormatString="{0:f2}"
                                                                HtmlEncode="False" />
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                            ...
                            <img src="images/rm_associationsbigbot.gif" alt="" />
                            <!--AssociationsTotals-->
                            <Ajax:UpdatePanel ID="updateAssociationsTotalExpenses" UpdateMode="conditional" runat="server">
                                <ContentTemplate>
                                    <div id="intdepBox2">
                                        <br />
                                        <asp:GridView ID="gv_TotalExpesnsesByDept" runat="server" BorderStyle="None" GridLines="None"
                                            Height="100%" Width="100%" AutoGenerateColumns="False" DataSourceID="AD419ExpensesByDept"
                                            CellSpacing="5">
                                            <Columns>
                                                <asp:BoundField DataField="Column1">
                        ...
                        <div style="float: right; width: 390px;">
                            <Ajax:UpdatePanel ID="UpdateAssociateRecords" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div style="background-image: url(images/rm_associationssm.gif); background-repeat: no-repeat;
                                        padding-left: 21px; padding-right: 20px; padding-top: 25px; padding-bottom: 10px;">
                                        <asp:ImageButton ID="btnUnassociateRecords" runat="server" OnClick="btnUnassociateRecords_Click"
                                            ImageUrl="images/unass_selrecord.gif" />
                                        <asp:ImageButton ID="btnAssociateRecords" runat="server" OnClick="btnAssociateRecords_Click"
                                            ImageUrl="images/ass_selrecord.gif" />
                                    </div>
                                </ContentTemplate>
                            </Ajax:UpdatePanel>
            ...
            --%>
                                            ...
                                            <Ajax:UpdatePanel ID="updateAssociationProjects" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:Label ID="lblError" runat="server" EnableViewState="False" Font-Size="Larger"
                                                        ForeColor="Red"></asp:Label><asp:GridView ID="gvAssociationProjects" runat="server"
                                                            AllowSorting="True" AutoGenerateColumns="False" DataSourceID="AD419AssociationsDataProjects"
                                                            CellPadding="4" CssClass="bordertop" ForeColor="#333333" GridLines="None" Enabled="False"
                                                            DataKeyNames="Accession" EmptyDataText="No Projects Found" Width="100%" OnDataBound="gvAssociationProjects_DataBound">
                                                            <Columns>
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="0%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtAssociatePercent" runat="server" Width="3em" AutoPostBack="True"
                                                                            OnTextChanged="txtAssociatePercent_TextChanged"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                            ...
                            <img src="images/rm_associationssmbot.gif" alt="" />
                        </div>
                    </asp:Panel>
                    <asp:Panel ID="pnlReports" runat="server">
                        <div style="float: left">
                            <div style="background-image: url(images/rm_bluemodbg.gif); background-repeat: repeat-y;
                                vertical-align: top; width: 429px;">
                                <div style="background-image: url(images/rm_bluemod_03.jpg); background-repeat: no-repeat;
                                    padding-left: 25px; height: 200px;">
                                    <br />
                                    <br />
                                    Report Type:
                ...
                --%>
                                    ...
                                    <asp:Panel ID="pnlGenerate" runat="server" Visible="false">
                                        ...
                                        <br />
                                        <br />
                                        <asp:Button ID="btnGenerate" runat="server" OnClick="btnGenerate_Click" OnClientClick="showProgress('GenerateProgress')"
                                            Text="Generate Report" />
                                        <span id="GenerateProgress" style="display: none;">Generating... Please Wait &nbsp;<img
                                            src="images/indicator_mozilla_blu.gif" alt="Progress" /></span></asp:Panel>
                            ...
                            <img src="images/rm_bluemod_05.jpg" alt="" /></div>
                    </asp:Panel>
                </td>
                <td style="width: 17px;">
                </td>
            ...
            <tr style="background-color: #ffffff;">
                <td style="width: 17px;">
                    <img src="images/corn_leftbot.gif" alt="" />
                </td>
                <td>
                </td>
                <td style="width: 17px;">
                    <img src="images/corn_rightbot.gif" alt="" />
                </td>
            </tr>
        </table>
    </div>
