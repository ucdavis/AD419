...
--	2014-10-29 bu kjt:
--		Revised to allow passing account number field so that AD-HOC reports via account numbers
--		would not exclude SFN 20x expenses.
-- =============================================
CREATE PROCEDURE [dbo].[usp_insertProjectExpenseWithAccount] 
...
INSERT INTO AllExpenses
           (OrgR, Chart, Account, Exp_SFN, Expenses, isAssociated, isAssociable, Sub_Exp_SFN, DataSource)
VALUES     (@OrgR, '3', @Account, @Exp_SFN,@Expenses, 1, 0, @SFN, @DataSource)
