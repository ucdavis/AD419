...
/*
	...
	SELECT * FROM [dbo].[udf_GetUserUnitsForApplication]('838163392', 'AD419')
	GO

*/
-- Modifications:
--	20191021 by kjt: Added Usage to comments section for testing.
--
-- =============================================
CREATE FUNCTION [dbo].[udf_GetUserUnitsForApplication]
(
...
WHERE Applications.Name = @ApplicationName AND Users.EmployeeID = @EmployeeID 
