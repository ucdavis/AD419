...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'PpsExpensesV';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'This view is a union of all of the individual PPS, i.e., labor related expense views to give an overall dataset of all the PPS expenses.  It basically replaces the data that was formerly available in the Expenses_PPS table.', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'PpsExpensesV';
