...
-- Usage: SELECT * FROM udf_GetDirectFFYExpensesByARC(2015)
-- =============================================
CREATE FUNCTION udf_GetDirectFFYExpensesByARC 
(
	@FiscalYear int
)
RETURNS 
...
where 
	...
	AND ConsolidationCode NOT LIKE 'INC0' AND ConsolidationCode NOT LIKE 'INDR'
	and Account NOT IN (
