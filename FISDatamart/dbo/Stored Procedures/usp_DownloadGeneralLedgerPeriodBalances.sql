...
Usage:
	...
	EXEC [dbo].[usp_DownloadGeneralLedgerPeriodBalances]
		@FirstDateString = '2019-06-01',
		@LastDateString = null,
		@GetUpdatesOnly = 0,
		@TableName = 'GeneralLedgerPeriodBalances',
		@IsDebug = 1
	GO
...
Modifications:
	...
	2019--06-17 by kjt: Added a Usage section for easier debugging.  Added "--" in front of printable comments.
*/
