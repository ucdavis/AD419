...
-- Description:	Merges the Accounts table so we can use it for figuring out
-- the VETM Scientist Years and VETM Cost Share Scientist Years, since we
-- do not normally load VETM account information into our local FIS DataMart.
-- Usage:
/*
...
EXEC	@return_value = [dbo].[usp_MergeVetMedAccounts]
		@FiscalYear = 2019,
		@IsDebug = 0
...
*/
-- Modifications
-- 2020-09-22 by kjt: Removed type causing syntax error.
--
-- =============================================
CREATE PROCEDURE [dbo].[usp_MergeVetMedAccounts] 
	@FiscalYear int = 2019, 
	@IsDebug bit = 0
AS
BEGIN
