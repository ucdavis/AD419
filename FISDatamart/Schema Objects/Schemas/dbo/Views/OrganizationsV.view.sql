...
SELECT DISTINCT 
                         ...
                         ORG4 = 'DANR' THEN Name6 WHEN CHART1 = '3' THEN Name2 ELSE Org5 END) AS Name2, ISNULL((CASE WHEN (Org1 = 'BIOS') 
                         THEN Chart2 WHEN (Org4 = 'BIOS') THEN Chart5 WHEN (CHART = '3' AND Org1 = 'AAES') THEN Chart3 WHEN (CHART = 'L' AND Org2 = 'AAES') 
                         THEN Chart4 WHEN (CHART = '3' AND Org4 = 'AAES') THEN Chart6 WHEN (CHART = 'L' AND Org5 = 'AAES') THEN Chart7 END), Chart) AS ChartR, 
                         ISNULL((CASE WHEN (Org1 = 'BIOS') THEN Org2 WHEN (Org4 = 'BIOS') THEN Org5 WHEN (CHART = '3' AND Org1 = 'AAES') THEN Org3 WHEN (CHART = 'L' AND 
                         Org2 = 'AAES') THEN Org4 WHEN (CHART = '3' AND Org4 = 'AAES') THEN Org6 WHEN (CHART = 'L' AND Org5 = 'AAES') THEN Org7 END), Org) AS OrgR, 
                         ISNULL((CASE WHEN (Org1 = 'BIOS') THEN Name2 WHEN (Org4 = 'BIOS') THEN Name5 WHEN (CHART = '3' AND Org1 = 'AAES') 
                         THEN Name3 WHEN (CHART = 'L' AND Org2 = 'AAES') THEN Name4 WHEN (CHART = '3' AND Org4 = 'AAES') THEN Name6 WHEN (CHART = 'L' AND Org5 = 'AAES') 
                         THEN Name7 END), Name) AS NameR, (CASE WHEN CHART1 = 'L' AND ORG1 = 'DANR' THEN Chart4 WHEN CHART4 = 'L' AND 
                         ORG4 = 'DANR' THEN Chart7 WHEN CHART1 = '3' THEN Chart3 ELSE Chart6 END) AS Chart3, (CASE WHEN CHART1 = 'L' AND 
                         ORG1 = 'DANR' THEN Org4 WHEN CHART4 = 'L' AND ORG4 = 'DANR' THEN Org7 WHEN CHART1 = '3' THEN Org3 ELSE Org6 END) AS Org3, 
                         (CASE WHEN CHART1 = 'L' AND ORG1 = 'DANR' THEN Name4 WHEN CHART4 = 'L' AND 
                         ...
                         Org5 = 'ACBS') OR
                         (Chart = '3' AND Org2 = 'ACBS')) THEN 2 WHEN ((Chart = '3' AND Org4 = 'AAES') OR
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'OrganizationsV';
