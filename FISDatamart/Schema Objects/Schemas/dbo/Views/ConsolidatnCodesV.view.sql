CREATE VIEW [dbo].[ConsolidatnCodesV]
AS
SELECT        udf_ConsolidatnCodesList_1.*
FROM            dbo.udf_ConsolidatnCodesList(DEFAULT, DEFAULT) AS udf_ConsolidatnCodesList_1
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "udf_ConsolidatnCodesList_1"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 135
