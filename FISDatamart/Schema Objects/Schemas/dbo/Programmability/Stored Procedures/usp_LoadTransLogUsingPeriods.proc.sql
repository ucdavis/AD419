...
--	20110311 by kjt:
--		Added period looping because tempdb log was filling up otherwise and process was failing.
--
-- =============================================
CREATE PROCEDURE [dbo].[usp_LoadTransLogUsingPeriods] 
...
INSERT INTO ' + @TableName + '
  ...
  WHERE 
		' + @WhereClause + ' AND FiscalPeriod = ''' + @Period + '''
'
	if @IsDebug = 1
		BEGIN
			--used for testing
