CREATE TABLE [dbo].[TransLogEmpty] (
...
GO
CREATE NONCLUSTERED INDEX [TransLogEmpty_TransBalType_YearPeriodChartAccountArcObjCdConsolCdExpdAmount_CVIDX]
    ON [dbo].[TransLogEmpty]([TransBalanceType] ASC)
...
GO
CREATE NONCLUSTERED INDEX [TransLogEmpty_TransBalType_IDX]
    ON [dbo].[TransLogEmpty]([TransBalanceType] ASC)
    INCLUDE([PartitionColumn]);


GO
CREATE NONCLUSTERED INDEX [TransLogEmpty_FYChartArcCodeConsolidationCodeTransBalType_IDX]
    ON [dbo].[TransLogEmpty]([FiscalYear] ASC, [Chart] ASC, [AnnualReportCode] ASC, [ConsolidationCode] ASC, [TransBalanceType] ASC)
...
GO
CREATE NONCLUSTERED INDEX [TransLogEmpty_FiscalYearBalType_CVIDX]
    ON [dbo].[TransLogEmpty]([FiscalYear] ASC, [TransBalanceType] ASC)
