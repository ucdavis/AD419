CREATE TABLE [data].[ActivityHierarchy]
(
    ...
    [LoadedAt]         DATETIME2(3)   NOT NULL CONSTRAINT [DF_ActivityHierarchy_LoadedAt] DEFAULT (SYSUTCDATETIME()),
    CONSTRAINT [PK_ActivityHierarchy] PRIMARY KEY CLUSTERED ([Code])
);
