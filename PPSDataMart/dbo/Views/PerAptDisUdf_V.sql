CREATE VIEW [dbo].[PerAptDisUdf_V]
AS
...
FROM            dbo.udf_PerAptDis(DEFAULT, DEFAULT) AS udf_PerAptDis_1
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'PerAptDisUdf_V';
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'PerAptDisUdf_V';
